import { type PayloadAction, type SerializedError } from "@reduxjs/toolkit";
...
declare const alertsSlice: import("@reduxjs/toolkit").Slice<import("@reduxjs/toolkit").EntityState<ErrorAlert, number> & AlertsExtraState, {
    addAlert: (state: {
        ...
        nextId: number;
    }, action: PayloadAction<Partial<ErrorAlert & Pick<ErrorAlert, "message">>>) => void;
    addError: (state: {
        ids: number[];
        entities: {
            [x: number]: {
        ...
        nextId: number;
    }, action: PayloadAction<Error | SerializedError>) => void;
    dismissAlert: (state: {
        ids: number[];
        entities: {
            [x: number]: {
        ...
        nextId: number;
    }, action: PayloadAction<Partial<Pick<ErrorAlert, "id" | "context">>>) => void;
}, "alerts", "alerts", {
...
export declare const addAlert: import("@reduxjs/toolkit").ActionCreatorWithPayload<Partial<ErrorAlert & Pick<ErrorAlert, "message">>, "alerts/addAlert">, dismissAlert: import("@reduxjs/toolkit").ActionCreatorWithPayload<Partial<Pick<ErrorAlert, "context" | "id">>, "alerts/dismissAlert">;
