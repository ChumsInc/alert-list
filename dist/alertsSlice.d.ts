...
import { StyledErrorAlert } from './alert-types.d.ts';
...
export declare const addAlert: import('@reduxjs/toolkit').ActionCreatorWithPayload<Partial<StyledErrorAlert & Pick<StyledErrorAlert, "message">>, "alerts/addAlert">, dismissAlert: import('@reduxjs/toolkit').ActionCreatorWithPayload<Partial<Pick<StyledErrorAlert, "id" | "context">>, "alerts/dismissAlert">;
